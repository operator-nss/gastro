(() => {
    ...
    function initSliders() {
        if (document.querySelector(".mainslider__slider")) mainSlider = new core(".mainslider__slider", {
        ...
        if (document.querySelector(".mainslider-image__slider")) photoSlider = new core(".mainslider-image__slider", {
        ...
        if (document.querySelector(".dishes__slider")) photoSlider = new core(".dishes__slider", {
            modules: [ Autoplay ],
            observer: true,
            observeParents: true,
            speed: 800,
    ...
    socialMainslider.addEventListener("mouseover", (() => {
        if (!socialClue.classList.contains("_hidden")) socialClue.classList.add("_hidden");
    }));
